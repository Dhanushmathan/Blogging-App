...
const CommentForm = ({ post, refreshComments }) => {
    ...
    return (
        <form className="fixed bg-white bottom-0 w-full max-w-md text-black border-t border-black/20 px-1.5 py-2 flex items-center gap-2" onSubmit={handleSubmit}>
            ...
            <div className='border border-gray-700 w-[87%] px-2 py-2.5 rounded-full'>
                <input
                    type="text"
            ...
            {
                comment.trim() && (
                    <button type='submit' className='bg-blue-600 p-2 rounded-full absolute right-2 lg:right-[1.1rem]'>
